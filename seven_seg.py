def seven_seg(number:str, x: int, y: int, scale: float) -> list:
    segments = [
       #(x, y, horiz, vert),
        (x + 2*scale, y, 10*scale, 2*scale),                # 0 top hoiz
        (x + 2*scale, y + 12*scale, 10*scale, 2*scale),     # 1 mid hoiz
        (x + 2*scale, y + 24*scale, 10*scale, 2*scale),     # 2 bot hoiz
        (x, y + 2*scale, 2*scale, 10*scale),                # 3 top left
        (x + 12*scale, y + 2*scale, 2*scale, 10*scale),     # 4 top right
